...
class EntryItem extends StatelessWidget {
  const EntryItem({super.key, required this.index, required this.entries});
            ...
            children: [
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius:
                        BorderRadius.circular(25.r), // Bordures arrondies
                  ),
                  child: Icon(
                      Icons
                          .local_laundry_service_sharp, // Icône représentant un moniteur
              ...
              Expanded(
                ...
                children: [
                  Text(entries[index].state ?? "",
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: Colors.black,
                          fontSize: 14.sp)),
                  Text(
                    entries[index].typeOfWash?.isNotEmpty == true
              ...
              Column(
                ...
                children: [
                  Text(entries[index].totalAmount.toString() + r' XFA',
                      style: TextStyle(
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
                          fontSize: 13.sp)),
